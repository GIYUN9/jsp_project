...
<body>
	...
	*변수(데이터) 출력 (c:out value="출력하고자하는값" [default="기본값"] [escapeXm="true | false"])
	...
	<c:out value="${outTest}" /> <br> <!-- escapeXml생략시 기본값이 ture == 태그해석 안됨 -->
	...
	<%-- 
	 ...
	 <pre>
	 - JAVA에 if-else, if-else if문과 비슷한 역할을 하는 태그
	 - 각 조건들을 c:choose의 하위요소로 c:when태그를 통해서 작성한다(else문의 역할 = c:otherwise)
	 </pre>
