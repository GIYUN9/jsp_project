...
<body>
	...
	<p>
		...
		기본적으로 EL은 JSP내장객체를 구분하지 않고 자동으로 모든 내장 객체 키값을 검색해서 존재하는 경우 값을 가져온다.
	</p>
	...
	<h3>3. 단 EL사용시 내장 객체들의 저장된 키값이 동일할 경우</h3>
	scope값 : ${scope} <br>
	<!-- 
	 ...
	 applicationScope담긴 값 :  ${applicationScope.scope } <br>
	 ...
	 <!-- 
	  ...
	  잘못접근할 경우 session classRoom : ${sessionScope.classRoom}
</body>
</html>